...
from flop_counter.jit_analysis import JitModelAnalysis
from flop_counter.jit_handles import (
    addmm_flop_jit,
    batchnorm_flop_jit,
    bmm_flop_jit,
    conv_flop_jit,
...
_DEFAULT_SUPPORTED_OPS: Dict[str, Handle] = {
    ...
    "aten::avg_pool2d": elementwise_flop_counter(0, 1),
    "aten::prelu": elementwise_flop_counter(0, 1),
